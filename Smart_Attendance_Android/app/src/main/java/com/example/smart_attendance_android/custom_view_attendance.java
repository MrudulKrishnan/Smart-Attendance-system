...
class custom_view_attendance extends BaseAdapter {
    private Context context;
    ArrayList<String> a;
    ArrayList<String> b;
    SharedPreferences sh;
    public custom_view_attendance(Context applicationContext, ArrayList<String> a, ArrayList<String> b) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_attendance,null);
