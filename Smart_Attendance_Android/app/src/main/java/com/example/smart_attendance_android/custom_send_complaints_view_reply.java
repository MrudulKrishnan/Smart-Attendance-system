...
class custom_send_complaints_view_reply extends BaseAdapter {
    ...
    public custom_send_complaints_view_reply(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d ) {
...
//        this.e=e;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_send_complaints_view_reply,null);
